  ...
  return (
    <div className="editor-section">
      ...
      <CaseStudiesField
        ...
        onUploadCaseStudy={onUploadCaseStudy}
...
function CaseStudiesField({
  ...
  CmsEditorProps,
  "onUpdateCaseStudy" | "onUploadCaseStudy" | "onAddCaseStudy" | "onRemoveCaseStudy"
> & {
  ...
  return (
    <div className="case-study-editor">
      <div className="case-study-editor-head">
        <span>Case study files and references</span>
      ...
      {caseStudies.map((asset, index) => (
        <div className="case-study-row" key={`${asset.url}-${index}`}>
          ...
          />
          <label className="mini-button case-study-upload-button">
            Upload
            <input
              ...
              type="file"
              onChange={(event) => {
                onUploadCaseStudy(index, event.target.files?.[0]);
                event.target.value = "";
              }}
            />
          </label>
