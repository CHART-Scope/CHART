...
help:
	...
	@printf "  make new-design     Run the connected CHART planning app on :3200\n"
	@printf "  make web            Run the older CHART Next shell on :3100\n"
...
new-design:
	$(NPM) run dev:new-design

new-design-build:
	$(NPM) run build:new-design

new-design-typecheck:
	$(NPM) run typecheck:new-design
